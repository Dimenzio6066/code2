...
(function (Assteroids) {
    ...
    function createPaths() {
        Assteroids.asteroidPaths = createAsteroidPaths(Assteroids.shapesAsteroids);
        Assteroids.ufoPath = createUfoPath();
    }
    Assteroids.createPaths = createPaths;
